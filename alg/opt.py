...
def get_params(alg, args, inner=False, alias=True, isteacher=False):
    ...
    if inner:
        ...
        if "AAE" in args.algorithm:
            params = [
                {"params": alg.encoder.parameters(), "lr": args.lr_decay2 * initlr},
                {"params": alg.decoder.parameters(), "lr": args.lr_decay2 * initlr},
    ...
    if "AAE" in args.algorithm:
        params.append(
            {"params": alg.adversarial.parameters(), "lr": args.lr_decay2 * initlr},
        )
